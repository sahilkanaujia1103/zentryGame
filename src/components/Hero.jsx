...
const Hero = () => {
  ...
  return (
    ...
    {/* {
      isLoading&&(<div className='flex-center absolute z-[100] h-dvh w-screen
      overflow-hidden '>
    ...
    <div className='absolute top-0 left-0 z-40 size-full'>
         <div className='mt-24 px-5 sm:px-10'>
          ...
          <p className='text-xl mb-5 max-w-64 font-robert-regular text-blue-100'>Enter the metagame <br /> unleash the play economy </p>
           <Button id={"watch-trailer"} title={"Watch Trailer" } leftIcon={<TiLocationArrow/>} 
            containerClass={"flex gap-1 !bg-yellow-300"}
           />
         </div>
    </div>
    </div>
